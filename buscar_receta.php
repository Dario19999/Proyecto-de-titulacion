    ...
    <br>
        ...
        <div class="form-row  h-100 justify-content-center align-items-center">
            <div class="form-group col-md-4 text-center">
                ...
                <div class="col-md-2 text-left" style="margin-left: 150px">
                    <div class="custom-control custom-radio margen">
                        ...
                        <label class="custom-control-label radio-inline" for="radio1" 
                        ><h4>Comidas</h4></label> 
                    </div>
                    
                    <div class="custom-control custom-radio margen">
                        <input type="radio" name="tipo" id="radio2" class="custom-control-input" value ="2">
                        <label  class="custom-control-label radio-inline" for="radio2" 
                        ><h4>Postres</h4></label> 
                    </div>

                    <div class="custom-control custom-radio margen">
                        <input type="radio" name="tipo" id="radio3" class="custom-control-input" value ="3">
                        <label  class="custom-control-label radio-inline" for="radio3" 
                        ><h4>Cocteles</h4></label> 
                    </div>
            ...
            <div class="form-group col-md-4 text-center">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" value="2" id="facilidad2" name="facilidad" class="custom-control-input">
                    <label class="custom-control-label" for="facilidad2">2</label>
                </div>

                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" value="3" id="facilidad3" name="facilidad" class="custom-control-input">
                    <label class="custom-control-label" for="facilidad3">3</label>
                </div>

                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" value="4" id="facilidad4" name="facilidad" class="custom-control-input">
